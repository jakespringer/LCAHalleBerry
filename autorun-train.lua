...
local numImages        = 5763;  -- Total number of images in dataset
...
local checkpointPath   = "/home/jspringer/Workspace/LCAHalleBerry/CurrentCheckpoint"
local inputPath        = "/home/jspringer/Workspace/LCAfaces/dataset/facesrand.txt";
local inputNamePath    = "/home/jspringer/Workspace/LCAfaces/dataset/facesrandtext.txt";
local inputavg         = "/home/jspringer/Average.png";
local outputPath       = "./" .. folderName .. "/";
local checkpointPeriod = (displayPeriod * 20); -- How often to write checkpoints
...
local dWMax            = 1;     --10;    --The learning rate
local VThresh          = .015*3;  -- .005; --The threshold, or lambda, of the network
local AMin             = 0;
local AMax             = infinity;
local AShift           = .015*3;  --This being equal to VThresh is a soft threshold
local VWidth           = 0; 
...
local pvParameters = {
   ...
   AdaptiveTimeScales = {
      ...
      triggerOffset                       = 0;
      baseMax                             = 0.11; --1.0; -- minimum value for the maximum time scale, regardless of tau_eff
      baseMin                             = 0.10; -- default time scale to use after image flips or when something is wacky
...
--------------------------------------------------------------------
  ...
  AvgToDiff = {
   ...
   V1ToError = {
      ...
      initWeightsFile                     = checkpointPath .. "/V1ToError_W.pvp";
   ...
   T1ToError = {
      ...
      sparseFraction                      = 0.9;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = checkpointPath .. "/T1ToError_W.pvp";
      useListOfArborFiles                 = false;
      combineWeightFiles                  = false;
      initializeFromCheckpointFlag        = false;
  ...
  P1ToT1Error = {
      ...
      sparseFraction                      = 0.9;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = checkpointPath .. "/P1ToT1Error_W.pvp";
      useListOfArborFiles                 = false;
      combineWeightFiles                  = false;
      initializeFromCheckpointFlag        = false;
      triggerLayerName                    = "InputText";
  ...
  V2ToV1Error = {
      ...
      sparseFraction                      = 0.9;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = checkpointPath .. "/V2ToV1Error_W.pvp";
      useListOfArborFiles                 = false;
      combineWeightFiles                  = false;
      initializeFromCheckpointFlag        = false;
      triggerLayerName                    = "InputVision";
  ...
  P1ToV2Error = {
      ...
      sparseFraction                      = 0.9;
      weightInitType                      = "FileWeight";
      initWeightsFile                     = checkpointPath .. "/P1ToV2Error_W.pvp";
      useListOfArborFiles                 = false;
      combineWeightFiles                  = false;
      initializeFromCheckpointFlag        = false;
      triggerLayerName                    = "InputVision";
