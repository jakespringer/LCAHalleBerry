...
local folderName    = "output-benign-nhb-unlabeled";
...
local inputPath        = "/home/jspringer/Workspace/LCAfaces/dataset/nothalleberry.txt";
local inputNamePath    = "/home/jspringer/Workspace/LCAfaces/dataset/nothalleberrytext.txt";
