...
class LFW_ResNet50(LFW_Model):
    ...
    def _deprocess(self, X):
        return (X + self.imagenet_mean)[..., ::-1].astype(np.uint8)

# End ResNet50

class LFW_InceptionV3(LFW_Model):
    def __init__(self, input_size=(64, 64), weights='imagenet', adam_params=None):
        self.model = None
        self.model_input_height, self.model_input_width = 224, 224
        self.input_height, self.input_width = input_size
...
class LFW_MobileNetV2(LFW_Model):
    def __init__(self, input_size=(64, 64), weights='imagenet', adam_params=None):
        self.model = None
        self.model_input_height, self.model_input_width = 224, 224
        self.input_height, self.input_width = input_size
...
class LFW_DenseNet121(LFW_Model):
    def __init__(self, input_size=(64, 64), weights='imagenet', adam_params=None):
        self.model = None
        self.model_input_height, self.model_input_width = 224, 224
        self.input_height, self.input_width = input_size
    ...
    def _deprocess(self, X):
        return (((X * self.imagenet_std) + self.imagenet_mean) * 255.).astype(np.uint8)
