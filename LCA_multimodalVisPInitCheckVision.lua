...
local nbatch           = 25;    --Batch size of learning
local nxSize           = 1;
local nySize           = 1;
local xPatchSize       = 16;
...
local numImages        = 150; --Total number of images in dataset
...
local inputPath        = "/home/jspringer/Workspace/LCAHalleBerry/analysis/deep-models/halleberry/dataset-downscale/faces_noisy.txt";
local inputavg         = "/home/jspringer/Average.png";
local outputPath       = "./output-noisy-downscale/";
